...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PA5     ------> ADC_IN5
    */
    GPIO_InitStruct.Pin = PT100_Pin|NTC_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA5     ------> ADC_IN5
    */
    HAL_GPIO_DeInit(GPIOA, PT100_Pin|NTC_Pin);
...
void HAL_TSC_MspInit(TSC_HandleTypeDef* htsc)
{
  ...
  /* USER CODE END TSC_MspInit 0 */
    ...
    PA3     ------> TSC_G1_IO4
    */
    GPIO_InitStruct.Pin = TOUCH_S_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF3_TSC;
    HAL_GPIO_Init(TOUCH_S_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = TOUCH_LED_Pin|TOUCH_D_Pin|TOUCH_U_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF3_TSC;
...
void HAL_TSC_MspDeInit(TSC_HandleTypeDef* htsc)
{
  ...
  /* USER CODE END TSC_MspDeInit 0 */
    ...
    PA3     ------> TSC_G1_IO4
    */
    HAL_GPIO_DeInit(GPIOA, TOUCH_S_Pin|TOUCH_LED_Pin|TOUCH_D_Pin|TOUCH_U_Pin);
